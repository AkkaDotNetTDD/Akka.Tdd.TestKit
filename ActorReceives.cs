...
namespace Akka.Tdd.TestKit
{
    public class ActorReceives<T>
    {
        ...
        public ActorReceives<InternalAnyMessage> WhenActorReceivesAnyMessage()
        {
            return new ActorReceives<InternalAnyMessage>(MessagesReceived, Container, ActorSystem, Mocks);
        }
